  ...
  return (
    <div className="flex flex-col space-y-5">
      ...
      <div className="flex justify-end gap-5">
        ...
        <button className="py-2 px-3 text-red-600 border-red-600 border hover:bg-red-700 hover:text-red-50 transition-all duration-300">
          Remove
        </button>
      </div>
    </div>
...
export default ReservationConfrim;
